    ...
    return (
        <div className="bg-white relative z-20 rounded-full w-full px-3 py-2 sm:px-4 sm:py-3 flex justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
                <Link href={"/"} className='text-sky-blue text-sm sm:text-base font-bold duration-300 hover:text-main-black rounded-full px-0 sm:px-3 py-2.5 lg:px-6 lg:py-3 sm:hover:bg-vivid'>
                    Sign In
                </Link>
                <Link href={"/"} className='text-white bg-blue text-sm sm:text-base hover:bg-vivid rounded-full px-3 py-2.5 lg:px-6 lg:py-3 font-bold duration-300 hover:text-main-black'>
                   Get Started
                </Link>
            ...
            <div className={`fixed md:hidden top-0 ${isMenuOpen ? 'left-0' : '-left-full'} duration-300 bg-blue h-screen w-full p-6 flex flex-col gap-4`}>
