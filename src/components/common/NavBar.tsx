        ...
        <div>
            <div className="bg-white relative z-50 rounded-full w-full px-3 py-2 sm:px-4 sm:py-3 flex justify-between items-center gap-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Link href={"/auth"} className='text-white bg-blue text-sm sm:text-base hover:bg-green rounded-full px-3 py-2.5 lg:px-6.25 font-bold duration-300 hover:text-white'>
                        Get Started
                    </Link>
