...
const LayoutHero = () => {
    return (
        <div className="bg-light-blue relative overflow-clip">
            ...
            <span className="w-395 lg:w-295 block h-111 absolute -bottom-10 -left-100 bg-[linear-gradient(to_top,#96C2EC_0%,#8EC1EE_31%,#74B6E9_41%,#35A3E5_48%,#1E8ADA_54%,#3983D4_72%)] min-[1600px]:blur-2xl"></span>
                <NavBar />
                <Hero />
            </div>
        </div>
